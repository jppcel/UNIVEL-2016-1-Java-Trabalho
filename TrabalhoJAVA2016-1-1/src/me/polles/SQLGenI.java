	...
	protected String getCreateTable(Connection con, Object obj) {
		...
		try{
			...
			for(int i = 0; i < attr.length; i++){
				...
				// Cria variÃ¡veis de nome e tipo da coluna
				String ColumnName;
				String ColumnType;
				...
				// Faz toda a verificaÃ§Ã£o para saber o nome da coluna, seu tipo e se a mesma Ã© PK
				...
				// Coloca as informaÃ§Ãµes no SQL
				StBu.append(ColumnName).append(" ").append(ColumnType);
			}
			// Informa quais sÃ£o as PKs e finaliza o SQL
			StBu.append(", PRIMARY KEY(").append(pk.toString()).append(")");
			StBu.append(");");
			// Guarda o SQL em uma variÃ¡vel e mostra na tela qual o SQL.
